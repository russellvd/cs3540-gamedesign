...
namespace TheVisualEngineLite
{
    public class TVELiteUtils
    {
        ...
        const string minimumVersionFor6000 = "6000.0.9";
        ...
        public static string IsVersionSupported()
        {
            string message = "";
            ...
            if (pipeline != "Standard")
            {
                ...
                if (!supported)
                {
                    var minimumVersion = minimumVersionFor2021;

                    if (version0 == 2022)
                    {
                        minimumVersion = minimumVersionFor2022;
                    }

                    if (version0 == 6000)
                    {
                        minimumVersion = minimumVersionFor6000;
                    }

                    message = "The current Unity version is not supported! The Visual Engine only supports " + minimumVersion + " or higher with the " + pipeline + " Render Pipeline!";
                }
            }
